...
public class ColorCheck {
    ...
    public void test1(){
     ...
     //   driver.manage().window().maximize();
        ...
        System.out.println(pink.getLocation());
        ...
        System.out.println(pink.getCssValue("background-color")); // color
        Assert.assertEquals(height,"22px");
        Assert.assertEquals(width,"22px");
        Assert.assertTrue(colorCode.contains("rgb(252, 202, 205)"));
        System.out.println("line-height: "+pink.getCssValue("line-height"));
